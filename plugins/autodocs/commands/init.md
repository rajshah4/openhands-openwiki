...
5. Write default OpenWiki-style, OKF-compatible documentation under `openwiki/`, with `openwiki/quickstart.md` as the required entrypoint.
6. Add valid OKF front matter to every concept page created under `openwiki/`.
7. Create or refresh `openwiki/index.md`, any needed nested `index.md` files, and `openwiki/log.md`.
8. Add or update only the top-level `AGENTS.md` and/or `CLAUDE.md` Autodocs reference section.
9. Record successful metadata in `openwiki/.last-update.json`.
